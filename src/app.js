...
Button2.addEventListener("click", () => {
  ...
  const arrOrdenado = bubbleSort(arrChildGeneratedLast);
  arrOrdenado.map(arr => {
    const col12 = document.createElement("div");
    col12.classList.add("col-12", "d-flex", "flex-row", "my-3", "p-2");
    col12.addEventListener("mouseover", cambiarColor);
    col12.addEventListener("mouseout", cambiarColor);
    const newArrOrder = bubbleSort(arr);
